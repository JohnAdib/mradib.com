...
## The baseline, current identity

Until John picks a candidate below, the current identity stays and gets
sharpened, never diluted: teal accent on zinc neutrals, soft glow panels,
lift-on-hover cards, the starfield, staggered reveals, Inter for English and
Vazirmatn for Persian. It is clean and credible; the gap is distinctiveness.

## The bar

Bold and unique: nobody else's personal site should look like this. If a
...
80% of users are on mobile. Every screen must be perfect across the full
range: small phones (iPhone SE, 375px), large phones (Pro Max class, 430px),
tablets (768 to 834px), desktop (1280 to 1440px), large desktop (1920px),
ultrawide (2560px and up). Design starts at the phone and scales up, never
the reverse. No horizontal scroll at any width, ever.

## Standing rules, any direction

- NEVER decorative vertical lines: no border-left eyebrow bars, no center
  rules, no vertical dividers on cards. John calls them a sign of
  AI-generated design.
- Maximum two CTA buttons in any hero or section.
- Sections must look designed, never like text lists: metric tiles, icon
  chips, imagery, glow treatments.
- The footer stays minimal.
- Dark mode is a first-class theme, never an afterthought.
