...
export function CtaOnDarkPanel({
	...
	return (
		<div className="py-24 sm:py-32">
			<div className="relative isolate overflow-hidden backdrop-blur-xs bg-gray-900 dark:bg-gray-900/80 dark:opacity-80 px-6 py-16 md:py-24 text-center shadow-2xl rounded-2xl sm:rounded-3xl sm:px-16">
