...
export const routesFa: ISiteRoute[] = [
	{ path: "/fa/excel", lastModified: "2026-07-19" },
	{ path: "/fa/powerpoint", lastModified: "2026-07-19" },
	{ path: "/fa/word", lastModified: "2026-07-19" },
	{ path: "/fa/cover-letter", lastModified: "2026-07-19" },
	{ path: "/fa/mysql-auto-backup", lastModified: "2026-07-19" },
