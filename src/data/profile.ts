...
export const profile: IProfile = {
	...
	oneLiner:
		"Engineering Manager & 2× startup co-founder — pioneering AI-first development in London.",
	shortBio:
		"John Adib (MrAdib) — Engineering Manager at Zapp in London, 2× startup co-founder, World's Most Influential Mentor 2024 (ADPList), speaker & AI-first pioneer.",
	bio50:
		"John Adib (MrAdib) is an Engineering Manager at Zapp in London and a two-time startup co-founder. Named ADPList's World's Most Influential Mentor (2024) and #1 Mentor in Europe (2024), he has spent 17+ years building products and teams — and now pioneers AI-first development, mentoring engineers through 600+ free sessions.",
	bio150:
		"John Adib is an Engineering Manager at Zapp in London, where he leads teams pioneering AI-first development — AI reviewers on every pull request, releases accelerated from monthly to weekly, and AI agents woven through the whole workflow. Over 17+ years he has co-founded two startups: Sarshomar, which raised $1M and reached roughly a million users in its first month, and Jibres, an e-commerce platform serving 1,200+ businesses that won a national award at the Iran Web Festival 2022. A mentor at heart, John has run 600+ free sessions on ADPList, where he was named the World's Most Influential Mentor of 2024 and #1 Mentor in Europe. He holds a UK Global Talent endorsement from Tech Nation, speaks at conferences including AI Coding Summit and React Advanced London, contributes to open source, previously taught 2,000+ students — and is a proud father of two daughters.",
