...
export function IndustryLists(): JSX.Element {
	return (
		<Accordion title="Skills by industry">
			<h4 id="marketing">Marketing skills</h4>
			...
			<h4 id="management">Management skills</h4>
			<Pre language="plaintext">
			...
			<h4 id="technical">Basic technical skills</h4>
			<Pre language="plaintext">
			...
			<h4 id="finance">Accounting and finance skills</h4>
			<Pre language="plaintext">
			...
			<h4 id="teaching">Teaching skills</h4>
			<Pre language="plaintext">
			...
			<h4 id="web-design">Web design skills</h4>
			<Pre language="plaintext">
			...
			<h4 id="analysis">Business analysis skills</h4>
			<Pre language="plaintext">
			...
			<h4 id="healthcare">Nursing and healthcare skills</h4>
			<Pre language="plaintext">
