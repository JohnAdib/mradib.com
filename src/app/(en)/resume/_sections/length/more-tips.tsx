...
export function LengthMoreTips(): JSX.Element {
	return (
		<>
			<h4 id="school">Remove your school education</h4>
			<p>
			...
			<h4 id="repetition">Remove repetitive entries</h4>
			<p>
			...
			<h4 id="trim">Keep the resume summary summarized</h4>
			<p>
			...
			<h4 id="builders">Use resume builder sites</h4>
			<p>
