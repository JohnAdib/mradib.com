...
export function LengthFitTips(): JSX.Element {
	return (
		<>
			<h3>How do I fit my resume on one page?</h3>
			...
			<h4>Focus on relevant information</h4>
			<p>
			...
			<h4>Achievements instead of responsibilities</h4>
			<p>
			...
			<h4>Remove unnecessary header space</h4>
			<p>
