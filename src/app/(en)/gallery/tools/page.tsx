    ...
    >
      <div className="space-y-20">
        <ToolsSection title="Camera">
          ...
          >
            A lightweight, travel-friendly, full-frame camera body,
            the Canon EOS R8 Mirrorless Camera offers powerful photo and video
            ...
            sensor paired with a DIGIC X processor.
            Together, this combination provides outstanding stills performance,
            impressive 4K 60p 10-bit video, and fast auto focus.
            A perfect choice for low-light portrait photography
            and wide, expansive landscapes.
          </Tool>
          <Tool
          ...
          >
            ...
            portraits, and even close-up sport and wildlife.
            At just 750g, it's ideal for the travelling photographer.
            Built-in Image Stabilizer technology allows for hand-held shooting
            at shutter speeds up to 5 stops.
            Shoot everything with a single lens,
            from big landscapes to powerful portraits and
            frame-filling action shots.
          </Tool>
        </ToolsSection>
        <ToolsSection title="Printer">
          ...
          >
            ...
            anywhere – it’s the perfect partner for your smartphone.
            Ink-free, wireless and small enough to slip in your pocket,
            Canon Zoemini 2 is the rechargeable photo printer that’s
            always with you when you need it.
            Snap and personalise photos on your mobile device,
            then get instant peel-and-stick prints.
            Wherever you are, this pocket-sized printer
            turns your smartphone snaps into beautiful photos.
          </Tool>
        </ToolsSection>
        <ToolsSection title="Video">
          ...
          >
            Tiny 4K camera for hands-free POV & Action Pod
            for remote control & live preview.
            Small camera, huge potential.
            Go completely hands-free and live in the moment!
