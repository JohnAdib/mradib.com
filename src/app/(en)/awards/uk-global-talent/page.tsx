	...
	return (
		<AwardLayout award={award}>
			...
			<p>
				...
				survey platform that raised $1M and reached roughly a million users in
				its first month) and Jibres (an e-commerce platform serving 1,200+
			...
			<p>
				...
				<a href="/mentor">mentoring sessions</a> — bring yours. Persian
				speakers: my free <a href="/fa/resume">resume-writing guide</a> is a
				good place to start.
			</p>
