...
export const metadata: Metadata = {
	title: "WorldSkills — National Medalist & Coach",
	description:
...
export default function Page() {
	return (
		<AwardLayout award={award}>
			...
			<p>
				The medals taught me to build under pressure — complete, working
				software against the clock, judged on details most users never see. But
				the part of the story I'm proudest of came after: from 2010 to 2015 I
				switched to the other side of the table as a WorldSkills expert and
				trainer, coaching the next generation of competitors — several of whom
				went on to win medals of their own.
			</p>
			<p>
