...
export const metadata: Metadata = {
	...
	description:
		"The story of John Adib: from a teenage WorldSkills medalist to a 2× startup co-founder and one of the world's most influential engineering mentors, now building AI-first in London.",
};
