...
export const metadata: Metadata = {
  ...
  description: 'تعداد محدودی جلسه رایگان برای کمک به شما برای پیشرفت در حرفه تکنولوژی. همین امروز یک جلسه رزرو کن!',
  twitter: {
...
export default function Page() {
  ...
  return (
    <>
      ...
      >
        سلام. من جان ادیب هستم،
        مهندس نرم‌افزار اصلی با علاقه‌ای به کمک به دیگران برای موفقیت.
        اکه دنبال افزایش مهارت‌های مهندسی نرم‌افزارت هستی،
        اگه می‌خوای رزومه‌ات رو بهتر کنی،
        اگه می‌خوای برای مصاحبه کاری آماده‌تر باشی،
        اگه میخوای در مهاجرت به کشورهای تکنولوژی‌محور راهنمایی بگیری،
