...
export function ExperienceBySeniority(): JSX.Element {
	return (
		<>
			<h3 id="seniority">چه میزان تجربه کاری در رزومه بنویسیم؟</h3>
			<p>
			...
			<h4 id="no-experience">بدون تجربه کاری</h4>
			<p>
			...
			<h4 id="entry-level">کاندیدای تازه‌کار Entry-level</h4>
			<p>تمام کارهایی که تاحالا انجام دادید رو لیست کنید.</p>

			<h4 id="mid-level">حرفه‌ای سطح متوسط Mid-level</h4>
			<p>فقط تجربیات کاری مرتبط با عنوان شغلی رو بنویسید.</p>

			<h4 id="senior">متخصصان ارشد Senior professionals</h4>
			<p>
				{" "}
