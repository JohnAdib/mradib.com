...
export function IndustryLists(): JSX.Element {
	return (
		<Accordion title="مهارت‌ها به تفکیک صنعت">
			<h4 id="marketing">مهارت‌های بازاریابی</h4>
			...
			<h4 id="management">مهارت‌های مدیریتی</h4>
			<Pre language="plaintext">
			...
			<h4 id="design">مهارت‌های طراحی</h4>
			<Pre language="plaintext">
			...
			<h4 id="technical">مهارت‌های فنی پایه</h4>
			<Pre language="plaintext">
			...
			<h4 id="finance">مهارت‌های حسابداری و مالی</h4>
			<Pre language="plaintext">
			...
			<h4 id="teaching">مهارت‌های آموزشی</h4>
			<Pre language="plaintext">
			...
			<h4 id="web-design">مهارت‌های طراحی وب</h4>
			<Pre language="plaintext">
			...
			<h4 id="analysis">مهارت‌های آنالیز بیزینس</h4>
			<Pre language="plaintext">
			...
			<h4 id="healthcare">مهارت‌های پرستاری و مراقبت‌های بهداشتی</h4>
			<Pre language="plaintext">
