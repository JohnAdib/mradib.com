  ...
  return (
    <section>
      ...
      <figure>
        ...
        <figcaption>
          خلاصه‌ای از اطلاعات مربوط به تجربه کاری در رزومه
        </figcaption>
      </figure>

      <h3>عنوان شغلی</h3>
      <p>
        همیشه عنوان شغلی رو اول بنویسید. وقتی استخدام‌کننده، رزومه شما رو با
        چشمش اسکن میکنه، تو یک نگاه میخواد ببینه که آیا شما تجربه کاری مرتبط
        دارید. فونت سایزش بهتره نسبت به بقیه متن‌ها بزرگ‌تر باشه و یا رنگش فرق
        کنه
      </p>
      <p>
      ...
      <p>
        ...
        آخرین شغل بجای تاریخ می‌تونید عبارت present رو بنویسید یعنی تا همین
        الان.
      </p>
      <p>
      ...
      <p>
        هسته اصلی هر تجربه کاری، این بخش هست. بسته به رشته، می‌تونید دستاوردها
        یا مسئولیت‌های خودتون رو ذکر کنید که در ادامه دقیق‌تر بررسی خواهیم کرد.
      </p>
      ...
      <p>
        یکی از اشتباهات رایج رزومه‌ها، اینه که فقط مسئولیت‌ها لیست میشن. در
        بیشتر موارد، استخدام‌کننده محدوده وظایف شما رو میدونه. بزارید با مثال
        پیش بریم. فرض کنیم شما مدیر فروش هستید. مسئولیت‌های شما احتمالا
        این‌هاست.
      </p>
      <ul>
      ...
      <p>
        اتفاقا این لیستی از مسئولیت‌های هر مدیر فروش است. ۹۰ درصد رزومه‌ها
        احتمالا به این موارد اشاره می‌کنن.
      </p>
      <p>
