	...
	return (
		<section>
			...
			<p>
				...
				نوشتن رزومه تسلط پیدا کردی و می‌تونی برید سراغ پیدا کردن شغل‌های جذاب. اگه
				موردی بوده که رعایت نکردی هم اشکال نداره، کمی وقت بزار و سعی کن اون‌ها رو
				تا حد امکان برطرف کنی.
			</p>
