...
const pageTitle = 'قالب رزومه' + pageResumeSuffix;
...
function PageContent(): JSX.Element {
  return (
    <section>
      ...
      <h3><abbr title="Chronological Resume Format">فرمت رزومه زمانی</abbr></h3>
      <p>محبوب‌ترین فرمت رزومه است و ایده‌آل برای کسانی است که تجربه کاری زیادی دارن که به شغل درخواستی مرتبط است. آخرین شغل در ابتدا لیست میشه و به ترتیب زمانی به عقب لیست می‌کنید.</p>
      <figure>
        <Image
      ...
      <h3><abbr title="Functional Resume Format">فرمت رزومه کاربردی</abbr></h3>
      ...
      <h3><abbr title="Combination Resume Format">فرمت رزومه ترکیبی</abbr></h3>
      ...
      <h2>انتخاب نرم‌افزار یا سرویس مناسب برای ساخت رزومه</h2>
      ...
      <p>اگر مایلید از مایکروسافت ورد استفاده کنید، میتونید به آدرس زیر سربزنید و از بین قالب‌های رایگان ورد رو دانلود کنید و توی سیستم خودتون به‌صورت آفلاین ویرایش کنید.</p>
      ...
      <p>اگر مایلید از Overleaf استفاده کنید، لینک زیر که یک فرمت استاندارد هست، پیشنهاد میشه.</p>
      ...
      <p>استفاده از ادیتورهای متنی ساده خیلی محبوب هست ولی مشکلی که داره اینه که شاید ساعت‌ها وقت شما برای طراحی تلف بشه. یه تغییر کوچک انجام میدی و بوم! کل رزومه به فنا میره و باید کلی وقت بزاری درستش کنی. این تبلیغیه که سایت‌های ساخت رزومه میزارن و ادعا میکنن که ساده و سریع می‌تونن رزومه شما رو بسازن.</p>
      ...
      <h2>بهترین چیدمان برای رزومه چیست؟</h2>
      ...
      <h4>حجم پی‌دی‌اف رو پایین نگه‌دار</h4>
      ...
      <h2>قالب رزومه سنتی یا خلاقانه؟</h2>
