...
const articleDescription =
  "واقعا فکر کردین رکروتر رزومه شما رو میخونه؟ چطوری تو ۶ ثانیه نظرشون رو جلب کنیم؟ جواب ساده است، خیلی ساده با یک قالب خوب برای رزومه. این صفحه رو بخون تا بفهمی چه قالب رزومه‌ای لازم داری";
const pageTitle = "آموزش رایگان انتخاب قالب رزومه کاری" + pageResumeSuffix;
const pageDesc =
  "انتخاب بهترین قالب رزومه کار سختیه؟ اگه بدونی چه فرقی دارن، نه! تمپلیت رزومه کاری و دانلود رایگان نمونه رزومه شرکت. ساخت رزومه فارسی رایگان";
  ...
  return (
    <section>
      ...
      <p>
        ...
        تفاوت اون‌ها در تاکید روی بخش خاص و نحوه مرتب‌کردن بخش‌هاست. تفاوت در
        این ساختارها در چینش بخش‌های مختلف رزومه است. تا اینجا ما اصلا کاری به
        گرافیک هر بخش نداریم
      </p>
      ...
      <figure>
        ...
        />
        <figcaption>
          ساختار رزومه ترکیبی یا هایبرید روی سابقه کاری و مهارت‌ها به‌صورت
          همزمان تاکید دارد.
        </figcaption>
      </figure>

      <h2 id="choose-software">
        انتخاب نرم‌افزار یا سرویس مناسب برای ساخت رزومه
      </h2>
      <p>
        بعد از انتخاب ساختار و قبل از اینکه بخواین شروع به نوشتن رزومه کنید،
        باید تصمیم بگیرید که با چه ابزاری میخواین رزومه خودتون رو بسازید.
        روش‌های مختلفی برای ساخت رزومه هست، از مایکروسافت ورد و سایر ادیتورهای
        متنی گرفته تا سایت‌هایی که برای ساخت رزومه ساخته شدن تا Overleaf و
      ...
      <p>
        <Link href="/fa/resume/length">چرا میگی رزومه باید یک صفحه باشه؟</Link>
      </p>
      ...
      <p>
        شما فقط باید نسخه پی‌دی‌اف رو استفاده کنید. ورد یا سایر فرمت‌ها برای
        شماست که بتونید ویرایش کنید. بقیه قراره فقط بخونن. پس فقط پی‌دی‌اف.
      </p>
