...
function PageContent(): JSX.Element {
  return (
    <section>
      ...
      <p>
        ای‌تی‌اس یک جور رباته که با فیلتر کردن صدها رزومه، فقط مواردی که
        مناسب‌تر هستن رو به دست منابع انسانی و استخدام‌کننده‌ها میرسونه.
      </p>
      <p>
      ...
      <p>
        ...
        کار سختی نخواهد بود. نکته این‌جاست که باید آگهی شغلی رو بخونید و رزومه
        رو متناسب با اون تنظیم کنید. برای این‌کار باید کلمات کلیدی رو پیدا کنید
        و توی رزومه خودتون ازشون استفاده کنید.
      </p>
      <p>
      ...
      <p>
        حالا برای اینکه رزومه خودمون رو برای این پیش‌نیازها تنظیم کنیم، کافیه
        این موارد رو توی رزومه خودتون اضافه کنید. البته منظورم مشابه اون‌هاست با
        توجه به دستاوردها و صلاحیت‌هایی که دارید.
      </p>
    </section>
  );
}
