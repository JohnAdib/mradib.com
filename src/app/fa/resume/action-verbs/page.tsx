...
const articleDescription =
	"هر دستاورد در رزومه باید با یک فعل اکشن شروع شود. لیستی ارزشمند و کاربردی از افعال اکشن مناسب برای استفاده در بخش دستاوردهای رزومه. سعی کنید از هر فعل بیش از ۲ بار استفاده نکنید.";
const pageTitle = "افعال مناسب برای دستاوردها در رزومه" + pageResumeSuffix;
const pageDesc =
	"لیستی ارزشمند و کاربردی از افعال اکشن مناسب برای استفاده در بخش دستاوردها. فعل مناسب برای شروع رزومه نویسی" +
	" | " +
	"Resume Action Verb";
