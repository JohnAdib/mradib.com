...
export function ResumeReferences(): JSX.Element {
  ...
  return (
    <section>
      <h2>منابع</h2>
      <p>این مقاله با استناد به منابع مختلفی نوشته شده و در ادامه با مستندات تکمیلی ترکیب شده که لیست اون‌ها رو میتونید در ادامه ببینید و متن اصلی رو در صورت تمایل مطالعه کنید. هر چند مطمئن باشید سعی کردم چیزی جا نیافتاده باشه.</p>
      ...
      <p>اگه شما هم نکته‌ای دارید که اضافه کنید یا فکر میکنید بخشی نیازمند اصلاح است، ممنون میشم اون رو برام بفرستید تا بتونم آپدیت کنم تا یک مرجع کامل برای نگارش رزومه به فارسی داشته باشیم.</p>
    </section>
  );
