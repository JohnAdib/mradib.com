...
const articleDescription =
  "اطلاعات تماس یک بخش حیاتی تو رزومه شماست. به‌نظر ساده‌ترین بخش رزومه است، اما یک اشتباه کوچک ممکنه ضرر بزرگی بزنه. پس این صفحه رو بخون تا مطمئن بشی همه چی درسته.";
const pageTitle = articleTitle + pageResumeSuffix;
const pageDesc =
  "اطلاعات تماس یک بخش حیاتی تو رزومه شماست. چطور اطلاعات تماس خودت رو در رزومه بنویسی؟";
...
function PageContent(): JSX.Element {
  return (
    <section>
      ...
      <Msg severity="error">
        به‌هیچ عنوان نیازی به ذکر جزئیات آدرس مثل آدرس کوچه و پلاک خونه‌تون
        نیست!
      </Msg>
      ...
      <p>
        یا نمونه کارهای خودتون رو آنلاین منتشر کردید؟ مثلا برای برنامه‌نویسان
        این می‌تونه آدرس گیت‌هاب یا برای دیزاینرها میتونه دریبل یا برای
        نویسنده‌ها مدیوم باشه.
      </p>
      <Msg severity="warning">
      ...
      <p>
        ...
        برای تصمیم‌گیری مهم نیست. بدتر از اون ممکنه منجر به تبعیض بر اساس سن
        بشه. اگه واقعا شرکتی نیاز داشته باشه توی فرم به‌صورت مجزا میگیره پس
        اصراری به قرار دادنش توی رزومه نداشته باشید.
      </p>
      ...
      <h3>آدرس خونه‌تون!</h3>
      <p>
        خیلی عجیبه که آدرس دقیق خونه رو تو بعضی از رزومه‌ها میبینم. کسی قرار
        نیست برای شما نامه پست کنه که نیازی بهش داشته باشه
      </p>
