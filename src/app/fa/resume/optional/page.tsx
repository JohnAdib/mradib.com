	...
	return (
		<section>
			...
			<p>
				...
				شغل‌های بین‌المللی، زبان انگلیسی رو باید روان صحبت کنیم. پس همه ما، حداقل
				دو زبان رو میدونیم. اگر شغلی نیاز به زبان خاص، مثلا آلمانی داشته باشه و
				شما هم بلد باشید، طبیعیه که ذکر کردنش در این بخش الزامی میشه و بحثی توش
				نیست. اما زمانی که شغل به انگلیسی هست و رزومه هم به انگلیسی، زبان فارسی
				چه کمکی میتونه بکنه؟ چه ارزشی به رزومه شما اضافه میکنه؟ اگه به‌نظرتون مهم
				نیست میتونید این بخش رو حذف کنید.
			</p>
			<p>
