...
function PageContent(): JSX.Element {
  return (
    <section>
      <p>
        اگه اولین تاثیر منفی باشه، احتمالا تا آخر باقی می‌مونه و تغییرش سخت
        خواهد بود. پس بیاین فرصت رو از دست ندیم و تا میتونیم با خلاصه‌ی عالی،
        نظر بیننده رو جلب کنیم.
      </p>
      <p>
        طبق آمار، استخدام‌کننده‌ها حدود <b>۶ ثانیه</b> برای برانداز کردن هر
        رزومه وقت میزان. بله، این همه زحمت می‌کشید برای ۶ ثانیه. تنها درصورتی که
        نظرشون جلب بشه زمان بیشتری می‌ذارن. یکی از بخش‌های مهم که می‌تونه نظرشون
        رو جلب کنه بخش خلاصه رزومه یا هدف هست که در کنار بخش اطلاعات تماس قرار
        می‌گیره.
      </p>
      ...
      <h2>هدف رزومه</h2>
      <p>
        در بعضی از شرایط، این بخش به‌عنوان هدف رزومه هم نام‌گذاری میشه که اشاره
        به حالتی که شما قصد تغییر زمینه کاری خودتون رو دارید یا تازه از دانشگاه
      ...
      <ol>
        ...
        <li>
          به‌دنبال x ماه یا سال تجربه فلان در عنوان شغلی فلان در شرکت فلان
        </li>
        <li>
