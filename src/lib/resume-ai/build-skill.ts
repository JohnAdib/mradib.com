...
const copy: Record<LanguageLocale, ISkillCopy> = {
	...
	"fa-IR": {
		...
		description:
			"نوشتن، بازنویسی یا بازبینی رزومه با روش مستر ادیب از جان ادیب. برای ساخت رزومه، تطبیق با آگهی شغلی، تبدیل وظایف به دستاورد، یا امتیازدهی رزومه از ۱۰۰.",
		heading: "# نویسنده رزومه (روش مستر ادیب)",
