...
const copy: Record<LanguageLocale, ILlmsCopy> = {
	...
	"fa-IR": {
		title: "چطور یک رزومه عالی بنویسیم: روش مستر ادیب",
		summary: `یک چارچوب ماشین‌خوان برای نوشتن رزومه از جان ادیب (مستر ادیب): ${totalPoints} امتیاز تاثیرگذاری در بخش‌های زیر. برای نوشتن، بازنویسی، بازبینی یا امتیازدهی هر رزومه از آن استفاده کن.`,
